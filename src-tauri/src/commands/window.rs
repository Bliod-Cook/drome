...
pub fn window_minimize(window: &WebviewWindow) -> Result<()> {
  window.minimize().map_err(|e| DromeError::Message(e.to_string()))?;
  Ok(())
}

pub fn window_maximize(window: &WebviewWindow) -> Result<()> {
  window.maximize().map_err(|e| DromeError::Message(e.to_string()))?;
...
pub fn window_unmaximize(window: &WebviewWindow) -> Result<()> {
  window.unmaximize().map_err(|e| DromeError::Message(e.to_string()))?;
...
pub fn window_close(window: &WebviewWindow) -> Result<()> {
  window.close().map_err(|e| DromeError::Message(e.to_string()))?;
  Ok(())
}

pub fn window_is_maximized(window: &WebviewWindow) -> Result<bool> {
  window.is_maximized().map_err(|e| DromeError::Message(e.to_string()))
}
...
pub fn window_get_size(window: &WebviewWindow) -> Result<(u32, u32)> {
  let size = window.inner_size().map_err(|e| DromeError::Message(e.to_string()))?;
